...
class translation:
    ...
    def change(self):
        ...
        # --- 翻訳 ---
        # インスタンスの取得（場所の取得）
        elem_username = browser.find_element_by_xpath(
        ...
        # 翻訳した文字の取得
        elem_text = str(
            browser.find_element_by_css_selector("span[jsname='W297wb']").text
        )
        # 終了処理
        browser.quit()
        return elem_text
...
class Application(tk.Frame):
    def __init__(self, master):
        ...
        self.Countdown_time_1 = Label(
            self,
            bg="black",
            font=("ToppanBunkyuMidashiMinchoStdN-ExtraBold", 60, "bold"),
            text=kigen_name_1,
            fg="#FF9933",
        )
